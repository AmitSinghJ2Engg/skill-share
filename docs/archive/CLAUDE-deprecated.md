...
- `projects/CLAUDE-product-pipeline.proj.md` — for "Product Pipeline" project (Domains 1-2.5)
- `projects/CLAUDE-launch-ops.proj.md` — for "Launch & Ops" project (Domains 3-4)
